package ar.org.centro8.curso.java.proyectofinal.utils.consola.x;

import java.util.Scanner;

/**
 * Consola X, se usa para simplificar el trábajo con la consola de sistema. La
 * consola de Netbeans Maven puede tener comportamiento distinto a la de
...
public class X {
     ...
     * Ejemplo de uso: X.request("Desea un café? S o N: ");
     *
     * @param message Pregunta al usuario
     * @return respuesta del usuario true en caso de (S s Y y) o false en caso
     * de (N n)
     */
    public static boolean request(String message) {
        print(message);
        String r = sc.nextLine();
        if (r.equalsIgnoreCase("y") || r.equalsIgnoreCase("s")) {
            return true;
        } else {
            return false;
        }
